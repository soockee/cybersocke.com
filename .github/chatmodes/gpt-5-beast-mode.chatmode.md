...
model: GPT-5 (copilot)
tools: ['runCommands', 'runTasks', 'upstash/context7/*', 'edit/editFiles', 'runNotebooks', 'search', 'new', 'extensions', 'todos', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo']
---
